  ...
  return (
    <main className="page-shell">
      ...
      <header className="hero section reveal">
        ...
        <h1>
          Building thoughtful full stack products from the terminal up.
        </h1>
        <p className="lede">
          Hey, I'm Anurag Rai: a 20-year-old Computer Science undergrad,
          Linux geek, audiophile, programmer, and system administrator. I enjoy
          writing minimalist Unix-style utilities and working with low-level OS
          components like the kernel and coreutils. This portfolio is the start
          of my full stack journey and a living log of what I am learning.
        </p>
      ...
      <section className="section reveal">
        <div className="split-grid">
          <article className="panel">
            ...
            <p>
              A few things that keep my perspective broad while I build software.
            </p>
            <ul>
              {interests.map((item) => (
                <li key={item}>{item}</li>
          ...
          <article className="panel">
            ...
            <ol>
              <li>
                Build a real-time home server dashboard in React that streams
                live system stats from the Linux /proc interface.
              </li>
              <li>
                Move into React Native after completing a few core React
                projects, then ship an Android app to securely configure
                specific sysctl parameters on my home server.
              </li>
              <li>
                Add a dedicated project write-up section to this site with a
                technical deep dive for every build.
              </li>
              <li>
                Complete Striver's DSA cheat sheet entirely in TypeScript,
                with clean implementations and notes.
              </li>
            </ol>
          </article>
        </div>
      ...
      <section className="section contact-cta reveal">
        <div className="section-head">
          <h2>Let's Connect</h2>
          <p>
            If you want to collaborate on full stack products, systems tools, or
            open source work, reach out here.
          </p>
        </div>
        <ul className="contact-links" aria-label="Contact links">
          <li>
            <a
              href="https://github.com/Dark-Matter7232"
              target="_blank"
              rel="noreferrer"
            >
