...
For nearly a decade, Linux was my primary desktop environment. I started with Slax, moved to Ubuntu Unity, then Mint, Puppy Linux, Arch, Artix, Void, and eventually Linux From Scratch (LFS). 
